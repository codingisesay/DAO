...
public function saveAddressDetails(Request $request)
{
    ...
    $validated = $request->validate([
        'application_id' => 'required|integer|exists:customer_application_details,id',
        'per_complex_name' => 'required|string|max:191',
        'per_flat_no' => 'required|string|max:191',
        'per_area' => 'required|string|max:191',
        'per_landmark' => 'required|string|max:191',
        'per_country' => 'required|string|max:191',
        'per_pincode' => 'required|string|max:191',
        'per_city' => 'required|string|max:191',
        'per_district' => 'required|string|max:191',
        'per_state' => 'required|string|max:191',

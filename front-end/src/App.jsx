...
const PublicRoute = ({ children }) => {
  ...
  if (isAuthenticated && isAuthenticated()) {
    // Redirect to appropriate dashboard based on user role if needed
...
// // Simulate authentication (use proper state/context in production)
// const isAuthenticated = () => !!localStorage.getItem("authToken");

// // Protect routes by redirecting unauthenticated users to LoginPage

...
const DocumentUpload = ({ onDocumentsUpdate, initialDocuments = [] }) => {
    ...
    const [documents, setDocuments] = useState(initialDocuments); // Use initialDocuments here
    const [uploadSide, setUploadSide] = useState('');
    const fileInputRef = useRef(null);
    const [loading, setLoading] = useState(false);

    // Update local state when initialDocuments changes
    useEffect(() => {

    ...
    return (
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="inline-block relative">
                    ...
                    {showNotification && (
                        <div ref={notifyRef}
                             className="dropdown-box absolute w-[240px] h-[200px] overflow-y-auto shadow-md"
                             style={{ bottom: 'calc(100% + 10px)', right: 0 }} // Position above the icon + 10px space
                        >
                            <NotificationDd />
                        </div>
                    )}
                ...
                <div className="inline-block relative">
                    ...
                    {showHelp && (
                        <div ref={helpRef}
                             className="dropdown-box rounded-lg absolute w-[200px] h-[200px] overflow-y-auto shadow-md"
                             style={{ bottom: 'calc(100% + 10px)', right: 0 }} // Position above the icon + 10px space
                        >
                            <Help />
                        </div>
                ...
                <div className="inline-block relative">
                    ...
                    {showTranslator && (
                        <div
                            style={{
                                position: "absolute",
                                // Adjust these values for positioning above
                                bottom: 'calc(100% + 10px)', // Pushes it 100% up from the bottom of the parent + 10px spacing
                                right: 0,
                                zIndex: 9999,
                                background: "#fff",
                                borderRadius: "8px",

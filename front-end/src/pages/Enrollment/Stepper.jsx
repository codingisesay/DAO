...
// const Stepper = ({ currentStep, complete, steps }) => {
//     // console.log("currentStep", currentStep, "complete", complete, "steps", steps);
//     const navigate = useNavigate();
//     const preference = window.matchMedia("(prefers-color-scheme: dark)").matches;
//     const [isDark, setIsDark] = useLocalStorage("isDark", preference);
//     const { logout } = useAuth();
...
//                                 <div className="stepper-subtitle">{step.subtitle}</div>
//                                 <div className="stepper-title">{step.title}</div>
//                                 {/* <span className="stepper-description">{` ${currentStep === i + 1 ? "active" : ""} ${i + 1 < currentStep || complete ? "completed" : ""}`}</span> */}
//                             </div>
//                         </div>
//                     ))}
//                 </div>

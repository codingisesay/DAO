...
//                 });
//                 setShowData(true);
//                 // Set auth_code to verifynumber for Aadhar
//                 setLocalFormData(prev => ({
//                     ...prev,
//                     ...userdummydata.aadhardetails,
//                     auth_code: prev.verifynumber
...
//                 });
//                 setShowData(true);
//                 // Set auth_code to verifynumber for PAN
//                 setLocalFormData(prev => ({
//                     ...prev,
//                     auth_code: prev.verifynumber
//                 }));
...
//         const updatedData = {
//             ...localFormData,
//             auth_type: selectedOption, // Use selectedOption as auth_type
//             verificationOption: selectedOption,
//             // auth_code is already set in localFormData from fetchShowData
//         };
...
//         const payload = {
//             auth_type: selectedOption,
//             auth_code: localFormData.auth_code, // Use auth_code instead of verifynumber
//             first_name: localFormData.first_name,
//             auth_status: "Pending",
//             adhar_card: selectedOption === 'Aadhar Card' ? localFormData.auth_code : '', // Only set if Aadhar
//             pan_card: selectedOption === 'Pan Card' ? localFormData.auth_code : '', // Only set if PAN
//             middle_name: localFormData.middle_name,
//             last_name: localFormData.last_name,
//             DOB: localFormData.DOB,
//             gender: localFormData.gender,

...
const PhotoCaptureApp = ({ formData, updateFormData, onNext, onBack, isSubmitting }) => {
    ...
    const submitPhoto = async (e) => {
        ...
        try {
            const response = await livePhotoService.upload(submitFormData);
...
//     formData.append('application_id', formData.application_id || application_id);
//     formData.append('longitude', localFormData.metadata?.location?.longitude ?? '');
//     formData.append('latitude', localFormData.metadata?.location?.latitude ?? '');
//     formData.append('photo', localFormData.file);
//     formData.append('status', 'Pending');

//     try {
//         const response = await livePhotoService.upload(formData);
...
//                     onClick={submitPhoto}
//                     variant="contained"
//                     className="btn-next" type='submit'
//                     // disabled={!localFormData || isSubmitting || localIsSubmitting}
//                 >
//                     {(isSubmitting || localIsSubmitting) ? (
//                         <>

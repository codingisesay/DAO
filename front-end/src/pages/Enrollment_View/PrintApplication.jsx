                    ...
                    <ColumnsLayout>
                        <Column>
                            ...
                            <KeyValueRow label={labels.landmark.label} value={formData.landmark} />
                              <KeyValueRow label="Permanent Resident" value={formData.per_resident} />
                            <KeyValueRow label="Residence Status" value={formData.per_residence_status} />
                            <KeyValueRow label="Residence Document" value={formData.resi_doc} />
                        </Column>
                        <Column>
